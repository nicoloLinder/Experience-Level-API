...
namespace UnityTests
{
    ...
    public class Tests
    {
        ...
        public void TestExperienceGetSetLevel()
        {
            ...
            ExperienceAPI.ExperienceAPI.SetCurrentLevel(entity.Id, 10);
            Assert.AreNotEqual(ExperienceAPI.ExperienceAPI.GetCurrentLevel(entity.Id), currentLevel);
        }
        ...
        public void TestCalculateExperience()
        {
            ...
            Assert.AreEqual(ExperienceAPI.ExperienceAPI.CalculateExperience(entity.Id, entity.Level),
                entity.Experience);
        }
        ...
        public void TestCalculateExperienceDelta()
        {
            ...
            Assert.AreEqual(ExperienceAPI.ExperienceAPI.CalculateExperienceDelta(entity.Id, 10), experienceDelta);
        }
        ...
        public void TestCalculateRemainingExperience()
        {
            ...
            Assert.AreEqual(ExperienceAPI.ExperienceAPI.CalculateRemainingExperience(entity.Id), remainingExperience);
        }
        ...
        public void TestCalculateProgress()
        {
            ...
            ExperienceAPI.ExperienceAPI.AddExperience(entity.Id, 33);

            Assert.AreEqual(ExperienceAPI.ExperienceAPI.CalculateProgress(entity.Id),
        ...
        public void TestAddSubtractExperience()
        {
            ...
            ExperienceAPI.ExperienceAPI.AddExperience(entity.Id, 10);
            Assert.AreEqual(currentExperience + 10, entity.Experience);
            
            ExperienceAPI.ExperienceAPI.SubtractExperience(entity.Id, 20);
            Assert.AreEqual(currentExperience - 10, entity.Experience);
        }
    }
}